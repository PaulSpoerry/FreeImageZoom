(function(win, doc) {
    ...
    win.addEventListener("contextmenu", function(e) {
        ...
        if (i) pdsp(e);
            ...
            PVI.TRG = PVI.resetNode = e.target;
            PVI.fireHide = true;
            PVI.x = e.clientX;
            PVI.y = e.clientY;
    ...
    var PVI = {
        ...
        state: null,
        rgxHTTPs: /^https?:\/\/(?:www\.)?/,
        page_protocol: win.location.protocol.replace(/^(?!https?:).+/, "http:"),
        palette: {
        ...
        create: function() {
            ...
            PVI.DIV.style.cssText = "margin: 0; padding: 0; " + (cfg.hz.css || "") + "; visibility: visible; cursor: default; display: none; z-index: 2147483647; " + "position: fixed !important; " + browser["box-sizing_css"] + ": content-box !important; left: auto; top: auto; right: auto; bottom: auto; width: auto; height: auto;";
            PVI.DIV.curdeg = 0;
            PVI.LDR.wh = [38, 38];
            ...
            PVI.LDR.style.cssText = (cfg.hz.LDRcss || "padding: 5px; border-radius: 50% !important; box-shadow: 0px 0px 5px 1px #a6a6a6 !important; background-clip: padding-box; width: 38px; height: 38px") +
                "; position: fixed !important; z-index: 2147483647; display: none; left: auto; top: auto; right: auto; bottom: auto; margin: 0; " + browser["box-sizing_css"] + ": border-box !important; " + (cfg.hz.LDRanimate ? browser["transition_css"] + ": background-color .5s, opacity .2s ease, top .15s ease-out, left .15s ease-out" : "");
        ...
        createCAP: function() {
            ...
            var n = PVI.CAP.firstChild;
            do n.IMGS_ = n.IMGS_c = true; while (n = n.nextSibling);
        ...
        attr_observer: function(target, isStyle, oldValue) {
            if (isStyle) {
                isStyle = target.style.backgroundImage;
                if (!isStyle || oldValue.indexOf(isStyle.slice(5, -2)) !== -1) return
            }
            PVI.reset_node(target)
        },
        attr_changed: function(e) {
            if (e.attrChange !==
                1) return;
            var target = e.target;
            switch (e.attrName) {
                ...
                case "title":
                case "alt":
                    if (target === PVI.TRG) PVI.resetNode = target;
                    else PVI.reset_node(target);
                    target.removeEventListener("DOMAttrModified", PVI.attr_changed)
            }
            e.stopPropagation()
        },
        ...
        reset_node: function(n, keep_album) {
            delete n.IMGS_c;
            delete n.IMGS_c_resolved;
            delete n.IMGS_thumb;
            delete n.IMGS_thumb_ok;
            delete n.IMGS_SVG;
            delete n.IMGS_HD;
            delete n.IMGS_HD_stack;
            delete n.IMGS_fallback_zoom;
            if (!keep_album) delete n.IMGS_album;
            if (n.localName !== "a") return;
            n = n.querySelectorAll('img[src], :not(img)[style*="background-image"],' + "b, i, u, strong, em, span, div");
            if (n)[].forEach.call(n, function(el) {
                if (el.IMGS_c) PVI.reset_node(el)
            })
        },
        getImages: function(el) {
            ...
            if (el.nodeType ===
                ...
                if (el.childElementCount === 1) {
                    ...
                    if (imgs.childElementCount === 1) imgs = imgs.firstElementChild;
                    if (imgs.src && !el.textContent.trim() && el.offsetWidth - imgs.offsetWidth < 25 && el.offsetHeight - imgs.offsetHeight < 25) el = imgs
                } else if (!el.childElementCount && el.parentNode.childElementCount <= 5 && !el.src && el.style.backgroundImage[0] !== "u")[el.previousElementSibling, el.nextElementSibling].some(function(sib) {
                    if (sib && sib.nodeName.toUpperCase() === "IMG" && sib.offsetParent === el.offsetParent && Math.abs(sib.offsetLeft -
                            el.offsetLeft) <= 10 && Math.abs(sib.offsetTop - el.offsetTop) <= 10 && Math.abs(sib.clientWidth - el.clientWidth) <= 30 && Math.abs(sib.clientHeight - el.clientHeight) <= 30) {
                        el = sib;
                        return true
                    }
                });
            ...
            if (imgs.imgSRC_o) {
                if (el.nodeType !== 1) imgs.imgSRC_o = PVI.normalize_url(imgs.imgSRC_o);
            ...
            if (el.nodeType === 1) {
                ...
                if (imgs.imgBG_o && (imgs.imgBG_o = imgs.imgBG_o.match(/\burl\(([^'"\)][^\)]*|"[^"\\]+(?:\\.[^"\\]*)*|'[^'\\]+(?:\\.[^'\\]*)*)(?=['"]?\))/g)) && imgs.imgBG_o && imgs.imgBG_o.length ===
                    1) {
                    el = imgs.imgBG_o[0];
                    imgs.imgBG_o = el.slice(/'|"/.test(el[4]) ? 5 : 4);
                    if (browser.firefox && !/^(https?:)?\/\//.test(imgs.imgBG_o)) imgs.imgBG_o = (imgs.imgBG_o[0] === "/" ? "https:" : doc.baseURI.replace(/[#?].*/, "").replace(/[^\/]+$/, "")) + imgs.imgBG_o;
                    imgs.imgBG = imgs.imgBG_o.replace(PVI.rgxHTTPs, "")
                }
            }
            return imgs.imgSRC || imgs.imgBG ? imgs : null
        },
        _replace: function(rule, addr, http, attr, to) {
            var ret, i, r;
            r = addr.replace(rule[attr], to);
            if (typeof to === "function") {
                ...
                if (r.indexOf("\n",
                    ...
                    for (i = 0; i < r.length; ++i) {
                        r[i] = PVI._replace(rule, addr, http, attr, r[i]);
        ...
        replace: function(rule, addr, http, attr, trg) {
            var ret, i, j;
            if (PVI.to_function(rule, "to") === false) return 1;
            if (typeof rule["to"] === "function" && !PVI.node) PVI.node = trg;
            http = http.slice(0, http.length - addr.length);
            if (Array.isArray(rule.to)) {
                ret = [];
                for (i = 0; i < rule.to.length; ++i) {
                    j = PVI._replace(rule, addr, http, attr, rule.to[i]);
                    if (Array.isArray(j)) ret = ret.concat(j);
                    else ret.push(j)
                }
            } else if (rule.to) ret = PVI._replace(rule, addr, http, attr, rule.to);
            else ret = PVI.http_prepend(addr, http);
            return ret
        },
        to_function: function(rule, param, inline) {
        ...
        http_prepend: function(url, http) {
            if (http) url =
                url.replace(/^(?!#?(?:https?:|\/\/|data:)|$)(#?)/, "$1" + http);
            if (url[1] === "/")
                if (url[0] === "/") url = PVI.page_protocol + url;
                else if (url[0] === "#" && url[2] === "/") url = "#" + PVI.page_protocol + url.slice(1);
            return url
        },
        normalize_url: function(url) {
            PVI.HLP.href = url.replace(/^(?![^:]{1,10}:)(\/\/)?/, url[0] === "/" ? "https://" : "http://");
            return PVI.HLP.href
        },
        resolve: function(URL, rule, trg, nowait) {
            if (!trg || trg.IMGS_c || trg.IMGS_c_resolved && !trg.IMGS_c_resolved.URL || win.location.href.replace(rgxHash, "") === (URL = URL.replace(rgxHash,
                    ""))) return false;
            var params, i;
            if (rule.rule) {
                params = rule;
        ...
        find: function(trg) {
            ...
            do
                if (n.nodeType === 1 ? n.nodeName.toUpperCase() === "A" : n.href !== void 0) {
                    if (n.childElementCount && doc.evaluate("iframe|object|embed|video|audio", n, null, 8, null).singleNodeValue) break;
                    if (trg.nodeType === 1) {
                        if (trg.childElementCount && ((tmp_el = doc.evaluate('.//*[self::img[@src] or self::*[contains(@style, "background-image:")]] | preceding-sibling::img[@src][1] | following-sibling::img[@src][1]', trg, null, 8, null).singleNodeValue) && (tmp_el.src !== void 0 || !trg.textContent.trim()) ||
                            n.parentNode.style.backgroundImage[0] === "u" && (tmp_el = n.parentNode) && tmp_el.childElementCount < 3 || n.style.backgroundImage[0] === "u" && (tmp_el = n)) && Math.abs(trg.offsetWidth - tmp_el.offsetWidth) <= 25 && Math.abs(trg.offsetHeight - tmp_el.offsetHeight) <= 25) imgs = PVI.getImages(tmp_el);
                        if (tmp_el) tmp_el = null;
                        attrModNode = n
                    } else n.href = PVI.normalize_url(n.href);
                    URL = n.href.replace(PVI.rgxHTTPs, "");
                    if (imgs && (URL === imgs.imgSRC || URL === imgs.imgBG) || win.location.href.replace(rgxHash, "") === n.href.replace(rgxHash, "")) break;
                    for (i = 0; rule = cfg.sieve[i]; ++i)
                        if (rule.link && rule.link.test(URL) || rule.img && (tmp_el = rule.img.test(URL))) {
                            ...
                            if (rule.res && (!tmp_el || !rule.to && rule.url)) {
                                if (PVI.to_function(rule, "url", true) === false) return 1;
                                if (typeof rule.url === "function" && !PVI.node) PVI.node = trg;
                                ret = rule.url ? URL.replace(rule[tmp_el ? "img" : "link"], rule.url) :
                                    URL;
                                ret = PVI.resolve(PVI.http_prepend(ret || URL, n.href.slice(0, n.href.length - URL.length)), {
                                    "id": i,
                                    "$": [n.href].concat((URL.match(rule[tmp_el ? "img" : "link"]) || []).slice(1)),
                                    "loop_param": tmp_el ? "img" : "link",
                                    "skip_resolve": ret === ""
                                }, trg.IMGS_TRG || PVI.node || trg)
                            } else ret = PVI.replace(rule, URL, n.href, tmp_el ? "img" : "link", trg);
                            if (ret === 1) return 1;
                            else if (ret === 2) return false;
                            if (typeof ret === "string" && n !== trg && trg.hasAttribute("src") && trg.src.replace(/^https?:\/\//, "") === ret.replace(/^#?(https?:)?\/\//, "")) ret =
                                false;
                            break
                        }
                    break
                    ...
                    for (; rule = cfg.sieve[i]; ++i)
                        if (use_img[0] || rule.img && (imgs.imgSRC && rule.img.test(imgs.imgSRC) || imgs.imgBG && (use_img[1] = rule.img.test(imgs.imgBG)))) {
                            ...
                            if (!rule.to && rule.res &&
                                ...
                                if (PVI.to_function(rule, "url", true) === false) return 1;
                                if (typeof rule.url === "function" && !PVI.node) PVI.node = trg;
                                ret = PVI.resolve(PVI.http_prepend(URL.replace(rule.img, rule.url), imgs.slice(0, imgs.length - URL.length)), {
                                    id: i,
            ...
            if (rule &&
                ...
                ret = PVI.find({
                    href: ret,
                    IMGS_TRG: trg.IMGS_TRG || PVI.node || trg,
        ...
        show: function(msg, delayed) {
            ...
            if (msg) {
                ...
                viewportDimensions();
                if (PVI.state < 3) win.addEventListener(browser["wheel"], PVI.wheeler, true);
                if (msg === true) {
                    PVI.BOX = PVI.DIV;
        ...
        set: function(src) {
            ...
            if (PVI.timers.onready) clearInterval(PVI.timers.onready);
            PVI.create();
            if (Array.isArray(src)) {
                ...
                for (i = 0; i < src.length; ++i) {
                    if (!src[i]) continue;
                    if (src[i][0] === "#") src_HD.push(PVI.http_prepend(src[i].slice(1)));
                    else src_left.push(PVI.http_prepend(src[i]))
                }
            ...
            if (src[1] === "/") src = PVI.http_prepend(src);
            src = src.replace(/&amp;/g, "&");
            ...
            if (src !== PVI.CNT.src) {
                ...
                if (PVI.TRG.IMGS_SVG && !PVI.stack[src]) {
                    ...
                    obj.style.cssText = "width:0!important; height:0!important; " + browser["box-sizing_css"] + ":border-box;";
        ...
        content_onready: function() {
            ...
            if (PVI.CNT === PVI.VID) {
                ...
                if (autoplay && browser.opera) setTimeout(function() {
                    if (!PVI.VID.paused && (PVI.VID.audio || PVI.VID.currentTime < .5)) {
                        PVI.VID.pause();
                        PVI.VID.play()
                    }
                }, 1500)
        ...
        content_onerror: function() {
            clearInterval(PVI.timers.onready);
            if (!PVI.TRG) return;
            var src_left, t = PVI.TRG,
                src_res_arr = t.IMGS_c_resolved,
                src = this.src;
            this.removeAttribute("src");
            do src_left = Array.isArray(src_res_arr) ?
                src_res_arr.shift() : null; while (src_left === src);
            ...
            console.info(app.name +
                ": [" + (this.audio ? "AUDIO" : this.nodeName) + "] Load error > " + src)
        },
        ...
        history: function(manual) {
            ...
            n = function() {
                ...
                i.style.cssText = ["position: fixed", "visibility: hidden", "height: 1px",
                    ""
                ].join("!important;");
                i.onload = function() {
                    this.onload = null;
        ...
        is_enlargeable: function(img, o_img) {
            if (PVI.CNT && PVI.CNT !== PVI.IMG) return true;
            if (!o_img) o_img = img;
            var w = img.clientWidth;
            var h = img.clientHeight;
            var ow = o_img.naturalWidth;
            var oh = o_img.naturalHeight;
            if (ow <= 64 && oh <= 64 || ow <= 1 || oh <= 1) return false;
            if (img === o_img || img.localName !== "img") {
                if (ow < 1E3 && oh < 1E3 && Math.abs(ow / 2 - (img.width || w)) < 2 &&
                    Math.abs(oh / 2 - (img.height || h)) < 2) return false
            } else if (/^[^?#]+\.(?:gif|apng)(?:$|[?#])/.test(o_img.src)) return true;
        ...
        not_enlargeable: function() {
            ...
            if (PVI.lastTRGStyle.outline ===
                null) PVI.lastTRGStyle.outline = PVI.TRG.style.outline;
        ...
        assign_src: function() {
            ...
            if (PVI.TRG.IMGS_album) {
                ...
                if (PVI.TRG !== PVI.HLP && PVI.TRG.IMGS_thumb && !PVI.is_enlargeable(PVI.TRG, PVI.IMG)) {
            ...
            if (browser.opera && PVI.TRG.IMGS_SVG) {
                var nextSib = PVI.IMG.nextElementSibling;
                PVI.DIV.removeChild(PVI.IMG);
                PVI.DIV.insertBefore(PVI.IMG, nextSib)
            }
            ...
            if (!PVI.fullZm && PVI.anim.maxDelay && PVI.TRG.IMGS_album) PVI.timers.no_anim_in_album = setTimeout(function() {
                PVI.DIV.style[browser["transition"]] =
                    PVI.anim.css
            }, 100)
        },
        hide: function(e) {
            ...
            if (animDIV && PVI.anim.opacity || animLDR) PVI.BOX.style.opacity =
                "0";
        ...
        keyup_freeze: function(e) {
            if (!e ||
                shortcut.key(e) === cfg.hz.actTrigger) {
                PVI.freeze = !cfg.hz.deactivate;
            ...
            if (e.altKey &&
                ...
                if (e.ctrlKey) {
                                ...
                                if (e.shiftKey) {
                                    ...
                                    if (pv) pv = pv.replace(/\/[cnfh]/g, function(t) {
                                        switch (t[1]) {
                                            ...
                                            case "n":
                                                t =
                                                    PVI.HLP.pathname.slice(1).split(".");
                    ...
                    if (PVI.fullZm)
                        ...
                        win.removeEventListener("mouseover",
                            PVI.m_over, true);
                        doc.removeEventListener(browser["wheel"], PVI.scroller, true);
                        doc.documentElement.removeEventListener(browser["mouseleave"], PVI.m_leave, false);
                    ...
                    if (!pv && PVI.TRG.IMGS_album) {
                        switch (key) {
                            ...
                            default:
                                pv = (key ===
                                    "Space" && !e.shiftKey || key === "Right" || key === "PgDn" ? 1 : -1) * (e.shiftKey && key !== "Space" ? 5 : 1)
                        }
                        if (pv !== null) {
                            PVI.album(pv, true);
                            pv = true
                    ...
                    PVI.DIV.curdeg += key === cfg.keys.rotR ? 90 :
                        -90;
        ...
        mover: function(e) {
            ...
            if (PVI.freeze ===
                true) PVI.freeze = !cfg.hz.deactivate;
            if (PVI.state && PVI.lastScrollTRG !== e.target) PVI.m_over(e);
            PVI.lastScrollTRG = null
        },
        wheeler: function(e) {
        ...
        m_move: function(e) {
            ...
            if (PVI.fullZm) {
                ...
                if (PVI.fullZm > 1 && e[0] !== true) {
                    ...
                    x = (w - PVI.DBOX["wpb"] > winW ? -(PVI.x * (w - winW + 80) /
                        winW) + 40 : (winW - w) / 2) + rot - PVI.DBOX["ml"];
            ...
            if (PVI.state < 3) {
                if (cfg.hz.delayOnIdle && PVI.fireHide !== 1 && PVI.state < 2) {
                    ...
                    clearTimeout(PVI.timers.preview);
                    PVI.timers.preview =
                        setTimeout(PVI.load, cfg.hz.delay)
                }
        ...
        _preload: function(srcs) {
            ...
            for (var i = 0, lastIdx = srcs.length - 1; i <= lastIdx; ++i) {
                ...
                (new Image).src = url[1] === "/" ? PVI.http_prepend(url) : url;
                return
            }
        },
        preload: function(e) {
            ...
            nodes = function() {
                var node, src, process_amount = 50;
        ...
        winOnMessage: function(e) {
            ...
            if (cmd === "toggle" || cmd === "preload" || cmd === "isFrame") {
                ...
                PVI.stack[url] = [win.screen.width, Math.round(win.screen.width /
                    d.ratio)];
                PVI.IMG.src = url;
                PVI.assign_src()
        ...
        onMessage: function(d) {
            if (d.cmd === "resolved") {
                ...
                if (!d.cache && (d.m === true || d.params.rule.skip_resolve)) {
                    try {
                        if (rule.res === 1 && typeof d.params.rule.req_res ===
                            "string") rule.res = Function("$", d.params.rule.req_res);
                        PVI.node = trg;
                ...
                if (d.m && !Array.isArray(d.m) && typeof d.m ===
                    "object")
                    if (d.m[""]) {
            ...
            if (win.MutationObserver) {
                ...
                if (!deinit) {
                    PVI.mutObserver = new win.MutationObserver(function(muts) {
                        ...
                        while (i--) {
                            var obj = muts[i];
                            var isStyle = obj.attributeName === "style";
                            if (isStyle && obj.target === PVI.TRG && PVI.fireHide) continue;
                            PVI.attr_observer(obj.target, isStyle, obj.oldValue)
                        }
                    });
                    PVI.mutObserverConf = {
                        attributes: true,
    ...
    if (browser.opera) opera.extension.addEventListener("disconnect", function() {
        PVI.init(null, true)
    });
    (function() {
        var count = 0;
